...
<script runat="server">
    ...
    Protected Sub Imprimir_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Biblioteca.EjecutarSql(Mensaje, "DELETE FROM FACTURA_TMP") Then ' Reiniciar la tabla temporal            
            ...
            While DtReader.Read
                If Trim(DtReader("MUESTRAESP").ToString) <> "" Then
                    SsqlTmp = " INSERT INTO FACTURA_TMP ( FECHAENTREGA, HORAENTREGA, COOPERATIVA, MINA, NUMEROENTRADA, MUNICIPIO, ACUMPESOS, HUMEDADTOT, CENIZAS, MATVOLATIL, AZUFRE, PODERCALORLHV, FACTORB, PESOCORREGIDO, PODERCALORTOT, NUMERO, VALORTOTALPESOS, PRECIO_GCAL, CAMION,HUMEDADSUP)" & _
        ...
        ssql = "SELECT  FACTURA_TMP.COOPERATIVA, FACTURA_TMP.FECHAENTREGA, FACTURA_TMP.HORAENTREGA, FACTURA_TMP.NUMEROENTRADA, FACTURA_TMP.ACUMPESOS, FACTURA_TMP.HUMEDADTOT, " & _
                      " CONVERT(DECIMAL(6,2),((100-FACTURA_TMP.HUMEDADSUP)/100)*FACTURA_TMP.CENIZAS) as CENIZAS, CONVERT(DECIMAL(6,2),((100-FACTURA_TMP.HUMEDADSUP)/100)*FACTURA_TMP.MATVOLATIL) as MATVOLATIL, CONVERT(DECIMAL(6,2),((100-FACTURA_TMP.HUMEDADSUP)/100)*FACTURA_TMP.AZUFRE) as AZUFRE, FACTURA_TMP.PODERCALORLHV, CONVERT(DECIMAL(6,5),(1.02033 - (0.000042 * POWER(FACTURA_TMP.HUMEDADTOT+(((100-FACTURA_TMP.HUMEDADSUP)/100)*FACTURA_TMP.CENIZAS),2)))) as FACTORB, " & _
