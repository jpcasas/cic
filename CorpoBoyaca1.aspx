...
<script runat="server">
    ...
    Private Sub GenerarReporte(ByVal Excel As Boolean)
        ...
        ssql = " SELECT HISTORICO_MUESTRAS.NUMERO, HISTORICO_MUESTRAS.ANOCORTE, HISTORICO_MUESTRAS.MESCORTE, HISTORICO_ENTREGAS.NUMEROENTRADA, HISTORICO_ENTREGAS.COOPERATIVA, HISTORICO_ENTREGAS.MINA, HISTORICO_ENTREGAS.MUNICIPIO, HISTORICO_ENTREGAS.PESONETO, HISTORICO_MUESTRAS.HUMEDADTOT, " & _
                      ...
                      " HISTORICO_MUESTRAS_1.ANOCORTE AS ANOCORTE1, HISTORICO_MUESTRAS_1.MESCORTE AS MESCORTE1, HISTORICO_MUESTRAS_1.NUMERO AS NUMERO1" & _
        ...
        If Biblioteca.EjecutarSql(Mensaje, "DELETE FROM CORPOBOYACATMP") Then ' Reiniciar la tabla temporal
            ...
            While DtReader.Read
                If Trim(DtReader("MUESTRAESP").ToString) <> "" Then
                    SsqlTmp = " INSERT INTO CORPOBOYACATMP  (NUMERO, ANOCORTE, MESCORTE, NUMEROENTRADA,COOPERATIVA, MINA, MUNICIPIO, PESONETO, HUMEDADTOT, CENIZAS, MATVOLATIL, AZUFRE, PODERCALORLHV)" & _
                              " VALUES ('" & DtReader("NUMERO1") & "', " & DtReader("ANOCORTE1") & "," & DtReader("MESCORTE1") & ",'" & DtReader("NUMEROENTRADA") & "','" & DtReader("COOPERATIVA") & "','" & DtReader("MINA") & "' , '" & DtReader("MUNICIPIO") & "', " & Replace(DtReader("PESONETO"), ",", ".") & ", " & Replace(DtReader("HUMEDADTOT1"), ",", ".") & ", " & Replace(DtReader("CENIZAS1"), ",", ".") & ", " & Replace(DtReader("MATVOLATIL1"), ",", ".") & " ," & Replace(DtReader("AZUFRE1"), ",", ".") & " , " & Replace(DtReader("PODERCALORLHV1"), ",", ".") & ")"
                Else
                    SsqlTmp = " INSERT INTO CORPOBOYACATMP  (NUMERO, ANOCORTE, MESCORTE, NUMEROENTRADA,COOPERATIVA, MINA, MUNICIPIO, PESONETO, HUMEDADTOT, CENIZAS, MATVOLATIL, AZUFRE, PODERCALORLHV)" & _
                              " VALUES ('" & DtReader("NUMERO") & "', " & DtReader("ANOCORTE") & "," & DtReader("MESCORTE") & ",'" & DtReader("NUMEROENTRADA") & "','" & DtReader("COOPERATIVA") & "','" & DtReader("MINA") & "' , '" & DtReader("MUNICIPIO") & "', " & Replace(DtReader("PESONETO"), ",", ".") & ", " & Replace(DtReader("HUMEDADTOT"), ",", ".") & ", " & Replace(DtReader("CENIZAS"), ",", ".") & ", " & Replace(DtReader("MATVOLATIL"), ",", ".") & " ," & Replace(DtReader("AZUFRE"), ",", ".") & " , " & Replace(DtReader("PODERCALORLHV"), ",", ".") & ")"
                End If
        ...
        Else
            If Not Excel Then
                ssql = "SELECT     COOPERATIVAS.DESCRIPCION AS COOPERATIVA, CORPOBOYACATMP.MINA, MINAS.DESCRIPCION AS NOMMINA, MUNICIPIOS.NOMBRE AS MUNICIPIO, " & _
                            ...
                            " ROUND(SUM(CORPOBOYACATMP.CENIZAS) / COUNT(CORPOBOYACATMP.COOPERATIVA), 2) AS CENIZAS, " & _
                            " ROUND(SUM(CORPOBOYACATMP.MATVOLATIL) / COUNT(CORPOBOYACATMP.COOPERATIVA), 2) AS MATVOLATIL, " & _
                            " ROUND(SUM(CORPOBOYACATMP.AZUFRE) / COUNT(CORPOBOYACATMP.COOPERATIVA), 2) AS AZUFRE, " & _
            ...
            Else
                ssql = "SELECT     CORPOBOYACATMP.COOPERATIVA as COD_COOP, COOPERATIVAS.DESCRIPCION AS COOPERATIVA, CORPOBOYACATMP.MINA as COD_PROVEEDOR, MINAS.DESCRIPCION AS PROVEEDOR, MUNICIPIOS.NOMBRE AS MUNICIPIO, " & _
                            " SUM(CORPOBOYACATMP.PESONETO) AS PESONETO, ROUND(SUM(CORPOBOYACATMP.HUMEDADTOT) / COUNT(CORPOBOYACATMP.COOPERATIVA),2) AS HUMEDADTOT," & _
                            " ROUND(SUM(CORPOBOYACATMP.CENIZAS) / COUNT(CORPOBOYACATMP.COOPERATIVA), 2) AS CENIZAS, " & _
                            " ROUND(SUM(CORPOBOYACATMP.MATVOLATIL) / COUNT(CORPOBOYACATMP.COOPERATIVA), 2) AS MATVOLATIL, " & _
                            " ROUND(SUM(CORPOBOYACATMP.AZUFRE) / COUNT(CORPOBOYACATMP.COOPERATIVA), 2) AS AZUFRE, " & _
