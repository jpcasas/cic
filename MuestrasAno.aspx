...
<script runat="server">
    ...
    Protected Sub BtnActualizar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case Session("ParamBD")
            Case "Actualizar"
                ssql = " UPDATE HISTORICO_MUESTRAS SET HISTORICO_MUESTRAS.NUMERO ='" & Me.NUMERO.Text & "',HISTORICO_MUESTRAS.FECHAMUESTRA ='" & Me.FECHAMUESTRA.Text & "',HISTORICO_MUESTRAS.COOPERATIVA ='" & Me.COOPERATIVA.Text & "',HISTORICO_MUESTRAS.ESTADO ='" & Me.ESTADO.Text & "',HISTORICO_MUESTRAS.ACUMPESOS ='" & Replace(Me.ACUMPESOS.Text, ",", ".") & "',HISTORICO_MUESTRAS.ENTREGA ='" & Me.ENTREGA.Text & "'" & _
                       " WHERE HISTORICO_MUESTRAS.NUMERO='" & Trim(Session("MUESTRA")) & "' AND HISTORICO_MUESTRAS.ENTREGA='" & Trim(Session("Entrega")) & "'"
            Case "Eliminar"
                ssql = " DELETE " & _
                       " FROM HISTORICO_MUESTRAS" & _
                       " WHERE HISTORICO_MUESTRAS.NUMERO='" & Trim(Session("MUESTRA")) & "' AND HISTORICO_MUESTRAS.ENTREGA='" & Trim(Session("Entrega")) & "'"
            Case "Insertar"
                ssql = " INSERT INTO HISTORICO_MUESTRAS(NUMERO, ENTREGA, COOPERATIVA,FECHAMUESTRA,ACUMPESOS, ESTADO)" & _
                       " VALUES('" & Me.NUMERO.Text & "', '" & Me.ENTREGA.Text & "', '" & Me.COOPERATIVA.Text & "','" & Me.FECHAMUESTRA.Text & "', '" & Replace(Me.ACUMPESOS.Text, ",", ".") & "', '" & Me.ESTADO.Text & "')"
        End Select
        
        Mensaje = ""
        If Biblioteca.EjecutarSql(Mensaje, ssql) Then
            Seguridad.RegistroAuditoria(Session("Usuario"), Session("ParamBD"), "MuestrasManualesAño", "Numero:" & Me.NUMERO.Text & ";Entrega:" & Me.ENTREGA.Text & ";Coop:" & Me.COOPERATIVA.Text & ";AcumPesos:" & Me.ACUMPESOS.Text, Session("GRUPOUS"))
...
<head runat="server">
    <title>Tabla Muestras Año</title>
</head>
<body>
            ...
            <table>
                <tr>
                    <td align="center" colspan="3" height="1" style="color: #000000">
                        <asp:Label ID="Label17" runat="server" Font-Bold="True" ForeColor="#336677" Text="Tabla Muestras Año" Width="179px"></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" style="width: 195px">
                        <asp:TextBox ID="NUMERO" runat="server" Width="105px"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td align="left" height="1" style="width: 195px">
                        <asp:TextBox ID="ENTREGA" runat="server" EnableTheming="True" Width="103px"></asp:TextBox></td>
                    <td align="left" height="1" style="width: 106px">
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" height="1" style="width: 195px">
                        <asp:TextBox ID="FECHAMUESTRA" runat="server" EnableTheming="True" Width="77px"></asp:TextBox><asp:Label
                ...
                <tr>
                    ...
                    <td align="left" height="1" style="width: 195px">
                        <asp:TextBox ID="COOPERATIVA" runat="server" EnableTheming="True" Width="104px"></asp:TextBox></td>
                    <td align="left" height="1" style="width: 106px">
                        </td>
                </tr>
                <tr>
                    ...
                    <td align="left" height="1" style="width: 195px">
                        <asp:TextBox ID="ACUMPESOS" runat="server" EnableTheming="True" Width="85px"></asp:TextBox></td>
                    <td align="left" height="1" style="width: 106px">
                    </td>
                </tr>
                <tr>
