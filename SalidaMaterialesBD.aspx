...
<script runat="server">
    ...
    Protected Sub BtnActualizar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Me.CODIGOENTRADA.Text = "" Or Me.FECHA.Text = "" Then
            ...
            Exit Sub
        End If
        If Session("CodProducto") = "" Then
            Me.mensaje.ForeColor = Color.Red
            Me.mensaje.Text = "No ha seleccionado Producto"
        End If
        Select Case Session("ParamBDProd")
            ...
            Case "Eliminar"
                ssql = " DELETE " & _
                      ...
                      " WHERE CODIGOENTRADA = " & Me.CODIGOENTRADA.Text & " AND CODIGOPRODUCTO= '" & Me.CODIGOPRODUCTO.Text & "'"
            Case "Insertar"
                ssql = " INSERT INTO CONTROLMATERIALES ( CODIGOENTRADA, CODIGOPRODUCTO, FECHA, HORAENTRADA, HORASALIDA, PESOENTRADA, PESOSALIDA, PESONETO, EMPRESA, CONDUCTOR, PLACA, OPERADORBASCULA, RECIBIDOPOR, DESPACHADOPOR, OBSERVACIONES,OBSERVACIONESSAL,IMPRESIONESENT,IMPRESIONESSAL )" & _
                       " VALUES('" & Me.CODIGOENTRADA.Text & "', '" & Session("CodProducto") & "', CONVERT(DATETIME, '" & Format(CDate(Me.FECHA.Text), "yyyy-MM-dd 00:00:00") & "', 102), '" & Me.HORAENTRADA.Text & "', '" & Me.HORASALIDA.Text & "', " & Me.PESOENTRADA.Text & ", " & Me.PESOSALIDA.Text & ", " & Me.PESONETO.Text & ", '" & Me.Empresa.SelectedItem.Value & "', '" & Me.CONDUCTOR.Text.ToUpper & "', '" & Me.PLACA.Text.ToUpper & "', '" & Me.OPERADORBASCULA.Text.ToUpper & "', '" & Me.RECIBIDOPOR.Text.ToUpper & "', '" & Me.DESPACHADOPOR.Text.ToUpper & "','-','-'," & IIf(Me.IMPRESIONESENT.Text = "", 0, Me.IMPRESIONESENT.Text) & ", " & IIf(Me.IMPRESIONESSAL.Text = "", 0, Me.IMPRESIONESSAL.Text) & ")"
        End Select
        
        Mensaje = ""
        If Biblioteca.EjecutarSql(Mensaje, ssql) Then
            Seguridad.RegistroAuditoria(Session("Usuario"), Session("ParamBD"), "SalidaMateriales", "Numero:" & Me.CODIGOENTRADA.Text & ";PesoEntrada:" & Me.PESOENTRADA.Text & ";PesoSalida:" & Me.PESOSALIDA.Text & ";PesoNeto:" & Me.PESONETO.Text, Session("GRUPOUS"))
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Me.Titulo.Text = UCase(Session("ParamBDProd") & " " & Session("NomProducto"))
    ...
    Private Sub Actualizar()
        ...
        If Session("ParamBDProd") <> "Insertar" Then
            ssql = " SELECT * " & _
              ...
              " WHERE PRODUCTO.NOMBRE LIKE '%" & Trim(Session("NomProducto")) & "%' AND CODIGOENTRADA = '" & Trim(Session("CodSal")) & "'"
            'Session("CodProducto")
            ...
            <table>
                <tr>
                    <td align="center" colspan="5" height="1" style="color: #000000">
                        <asp:Label ID="Titulo" runat="server" Font-Bold="True" ForeColor="#336677" Text="Materiales" Width="179px"></asp:Label></td>
                </tr>
                <tr>
