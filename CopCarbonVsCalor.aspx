            ...
            While DtReader.Read
                If Trim(DtReader("MUESTRAESP").ToString) <> "" Then
                    SsqlTmp = " INSERT INTO CARBON_VS_CALORTMP  (NUMEROENTRADA,COOPERATIVA, MINA, MUNICIPIO, ACUMPESOS, HUMEDADTOT, CENIZAS, MATVOLATIL, AZUFRE, PODERCALORLHV, FACTORB, NUMERO)" & _
                              " VALUES ('" & DtReader("NUMEROENTRADA") & "','" & DtReader("COOPERATIVA") & "','" & DtReader("MINA") & "' , '" & DtReader("MUNICIPIO") & "', " & Replace(DtReader("PESONETO"), ",", ".") & ", " & Replace(DtReader("HUMEDADTOT1"), ",", ".") & ", " & Replace(DtReader("CENIZAS1"), ",", ".") & ", " & Replace(DtReader("MATVOLATIL1"), ",", ".") & " ," & Replace(DtReader("AZUFRE1"), ",", ".") & " , " & Replace(DtReader("PODERCALORLHV1"), ",", ".") & "," & Replace(DtReader("FACTORB1"), ",", ".") & ",'" & DtReader("MUESTRAESP") & "')"
                Else
                    SsqlTmp = " INSERT INTO CARBON_VS_CALORTMP  (NUMEROENTRADA,COOPERATIVA, MINA, MUNICIPIO, ACUMPESOS, HUMEDADTOT, CENIZAS, MATVOLATIL, AZUFRE, PODERCALORLHV,FACTORB)" & _
                              " VALUES ('" & DtReader("NUMEROENTRADA") & "','" & DtReader("COOPERATIVA") & "','" & DtReader("MINA") & "' , '" & DtReader("MUNICIPIO") & "', " & Replace(DtReader("PESONETO"), ",", ".") & ", " & Replace(DtReader("HUMEDADTOT"), ",", ".") & ", " & Replace(DtReader("CENIZAS"), ",", ".") & ", " & Replace(DtReader("MATVOLATIL"), ",", ".") & " ," & Replace(DtReader("AZUFRE"), ",", ".") & " , " & Replace(DtReader("PODERCALORLHV"), ",", ".") & "," & Replace(DtReader("FACTORB"), ",", ".") & ")"
                End If
