...
<script runat="server">
    ...
    Protected Sub CrearArchivo_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ssql = "SELECT     FACTURA_TMPXLS.FECHAENTREGA AS fecha, FACTURA_TMPXLS.CAMION AS placa, FACTURA_TMPXLS.NUMEROENTRADA AS código, " & _
                      ...
                      " HISTORICO_ENTREGAS.HORASALIDA AS horasal, FACTURA_TMPXLS.HUMEDADTOT AS humedad, FACTURA_TMPXLS.CENIZAS AS cenizas, " & _
                      " FACTURA_TMPXLS.MATVOLATIL AS volatil, FACTURA_TMPXLS.AZUFRE AS azufre, FACTURA_TMPXLS.PODERCALORLHV AS pcal, " & _
                      " FACTURA_TMPXLS.PESOCORREGIDO AS p_correg, FACTURA_TMPXLS.FACTORB AS f_b, FACTURA_TMPXLS.PODERCALORTOT AS t_mcal, " & _
