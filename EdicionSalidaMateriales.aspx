...
<script runat="server">
    ...
    Protected Sub BtnActualizar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        End If
        Select Case Session("ParamBDCen")
            Case "Actualizar"
            ...
            Case "Eliminar"
                ssql = " DELETE " & _
                      ...
                      " WHERE CODIGOENTRADA = " & Me.CODIGOENTRADA.Text & " AND CODIGOPRODUCTO= '" & Me.CODIGOPRODUCTO.Text & "'"
            Case "Insertar"
                ssql = " INSERT INTO CONTROLMATERIALES ( CODIGOENTRADA, CODIGOPRODUCTO, FECHA, HORAENTRADA, HORASALIDA, PESOENTRADA, PESOSALIDA, PESONETO, EMPRESA, CONDUCTOR, PLACA, OPERADORBASCULA, RECIBIDOPOR, DESPACHADOPOR, CENIZAVOLATIL, CENIZAESCORIA, CENIZAPATIO, INDUSTRIA,OBSERVACIONES,OBSERVACIONESSAL )" & _
                       " VALUES('" & Me.CODIGOENTRADA.Text & "', '" & Me.CODIGOPRODUCTO.Text & "', CONVERT(DATETIME, '" & Format(CDate(Me.FECHA.Text), "yyyy-MM-dd 00:00:00") & "', 102), '" & Me.HORAENTRADA.Text & "', '" & Me.HORASALIDA.Text & "', " & Me.PESOENTRADA.Text & ", " & Me.PESOSALIDA.Text & ", " & Me.PESONETO.Text & ", '" & Me.Empresa.SelectedItem.Value & "', '" & Me.CONDUCTOR.Text.ToUpper & "', '" & Me.PLACA.Text.ToUpper & "', '" & Me.OPERADORBASCULA.Text.ToUpper & "', '" & Me.RECIBIDOPOR.Text.ToUpper & "', '" & Me.DESPACHADOPOR.Text.ToUpper & "', " & IIf(Me.Volatil.Checked = True, -1, 0) & ", " & IIf(Me.Escoria.Checked = True, -1, 0) & ", " & IIf(Me.Patio.Checked = True, -1, 0) & ", " & IIf(Me.Industria.Checked = True, -1, 0) & ", '-','-')"
        End Select
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Me.BtnActualizar.Text = Session("ParamBdCen")
    ...
    Private Sub Actualizar()
        ...
        If Session("ParamBdCen") <> "Insertar" Then
            ssql = " SELECT * " & _
              " FROM   CONTROLMATERIALES INNER JOIN " & _
                       " PRODUCTO ON CONTROLMATERIALES.CODIGOPRODUCTO = PRODUCTO.CODIGO " & _
              " WHERE PRODUCTO.NOMBRE LIKE '%CENIZA%' AND CODIGOENTRADA = '" & Trim(Session("CodSalCeniza")) & "'"
        ...
        <td style="height: 372px">
            <table>
                ...
                <tr>
                    ...
                    <td align="left" height="1" style="width: 195px">
                        <asp:TextBox ID="HORAENTRADA" runat="server" EnableTheming="True" Width="66px"></asp:TextBox><asp:Label ID="Label2" runat="server" Font-Size="0.65em" ForeColor="Silver" Text="(HH:MM AM/PM)" Width="113px"></asp:Label></td>
                    <td align="left" height="1" style="width: 20px">
