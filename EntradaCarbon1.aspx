...
<script runat="server">
    ...
    Protected Sub txtCodBarras_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            'dTReader.Close()
            'conn.Close()
            PROVEEDOR.Text = txtCodBarras.Text
...
<script language="JavaScript" type="text/javascript">
 ...
 $(function(){
  $('#ctl00_ContentPlaceHolder1_PROVEEDOR').focus();
});
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server" >
            ...
            <!--<tr>
                ...
                <td style="height: 3px" width="2">
                    <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="CustomValidator" ControlToValidate="txtCodBarras" OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator></td>
                <td style="height: 3px" width="2">
                </td>
                <td style="height: 3px;" width="2">
                </td>
