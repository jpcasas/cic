        ...
        Else
            ...
            Else
                ssql = "SELECT     CORPOBOYACATMP.COOPERATIVA as COD_COOP, COOPERATIVAS.DESCRIPCION AS COOPERATIVA, CORPOBOYACATMP.MINA as COD_PROVEEDOR, MINAS.DESCRIPCION AS PROVEEDOR, MUNICIPIOS.NOMBRE AS MUNICIPIO, " & _
                            " SUM(CORPOBOYACATMP.PESONETO) AS PESONETO, ROUND(SUM(CORPOBOYACATMP.HUMEDADTOT) / COUNT(CORPOBOYACATMP.COOPERATIVA),2) AS HUMEDADTOT," & _
                            " ROUND((((100-(SUM(CORPOBOYACATMP.HUMEDADTOT) / COUNT(CORPOBOYACATMP.COOPERATIVA)))/100)*(SUM(CORPOBOYACATMP.CENIZAS) / COUNT(CORPOBOYACATMP.COOPERATIVA))), 2) AS CENIZAS, " & _
                            " ROUND((((100-(SUM(CORPOBOYACATMP.HUMEDADTOT) / COUNT(CORPOBOYACATMP.COOPERATIVA)))/100)*(SUM(CORPOBOYACATMP.MATVOLATIL) / COUNT(CORPOBOYACATMP.COOPERATIVA))), 2) AS MATVOLATIL, " & _
                            " ROUND((((100-(SUM(CORPOBOYACATMP.HUMEDADTOT) / COUNT(CORPOBOYACATMP.COOPERATIVA)))/100)*(SUM(CORPOBOYACATMP.AZUFRE) / COUNT(CORPOBOYACATMP.COOPERATIVA))), 2) AS AZUFRE, " & _
                            " ROUND(SUM(CORPOBOYACATMP.PODERCALORLHV) / COUNT(CORPOBOYACATMP.COOPERATIVA), 2) AS PODERCALORTOT" & _
                        " FROM     CORPOBOYACATMP LEFT OUTER JOIN MUNICIPIOS ON CORPOBOYACATMP.MUNICIPIO = MUNICIPIOS.NUMERO LEFT OUTER JOIN " & _
                            " COOPERATIVAS ON CORPOBOYACATMP.COOPERATIVA = COOPERATIVAS.NUMERO LEFT OUTER JOIN MINAS ON CORPOBOYACATMP.MINA = MINAS.NUMERO " & _
                        " GROUP BY CORPOBOYACATMP.COOPERATIVA, CORPOBOYACATMP.MINA, MINAS.DESCRIPCION, COOPERATIVAS.DESCRIPCION, MUNICIPIOS.NOMBRE " & _
