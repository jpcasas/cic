...
<script runat="server">
    ...
    Protected Sub PROVEEDOR_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            If dTReader.Read() Then
                ...
                End If
                Dim coop As String = BIBLIOTECA.ContrCoopMina(Me.PROVEEDOR.Text,2)
                Me.mensaje.ForeColor = Color.Red
                ...
                lblConsecutivo.Text = BIBLIOTECA.GetContador(coop, "1")
    ...
    Protected Sub Guardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Biblioteca.EjecutarSql(Mensaje, ssql) Then
            ...
            BIBLIOTECA.GetContador(Biblioteca.ContrCoopMina(Trim(Me.PROVEEDOR.Text), 2),"0")
            Limpiar()
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <tr>
                ...
                <td style="width: 98px; height: 37px;">
                    <asp:Label ID="Label3" runat="server" Text="Número de Entrega" Width="130px" ForeColor="#336677"></asp:Label></td>
            ...
            <tr>
                ...
                <td style="width: 98px; height: 26px">
                    <asp:Label ID="Label15" runat="server" ForeColor="#336677" Text="Consecutivo Cooperativa"
                        Width="148px"></asp:Label></td>
                <td style="width: 100px; height: 26px;">
                    &nbsp;<asp:Label ID="lblConsecutivo" runat="server" ForeColor="Green" Width="148px" Font-Size="Medium"></asp:Label></td>
            </tr>
            <tr>
