...
<script runat="server">
    ...
    Private Function ImportarDesdeCsv(ByVal Ruta As String) As String
        ...
        Ssql = "DELETE FROM CONDUCTORESVEHICULOS "
            ...
            While Cadena <> ""
                ...
                If Placa <> "" Then
                    ...
                    Try
                        ...
                        Ssql = "INSERT INTO CONDUCTORESVEHICULOS (conductor,placas,cedula) VALUES('" & Conductor & "','" & Placa & "','" & Cedula & "')"
                        cmd = New SqlCommand(Ssql, conn)
                        miDataReader = cmd.ExecuteReader()
...
<head runat="server">
    <title>Importar Vehiculos conductores</title>
</head>
<body>
            ...
            <table style="width: 347px; height: 182px">
                <tr>
                    <td align="center" colspan="2" height="1" style="color: #000000">
                        <asp:Label ID="Label17" runat="server" Font-Bold="True" ForeColor="#336677" Text="Importar Vehiculos Conductores" Width="179px"></asp:Label></td>
                </tr>
                <tr>
                    <td align="left" colspan="2" style="height: 24px; text-align: center">
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Red" Text="Se actualizaran todos los campos de la tabla VehiculosConductores, y se crearan los registros que no se encuentren actualmente"></asp:Label></td>
                </tr>
                <tr>
