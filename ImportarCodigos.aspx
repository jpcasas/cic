...
<script runat="server">
    ...
    Protected Sub BtnActualizar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Cargado Then
            ...
            Catch ex As Exception
                archivosplanos.GeneraArchivoBascula("c:\temp", "ErrorExcel2.txt", ex.Message)
            End Try
    ...
    Private Function ImportarDesdeCsv(ByVal Ruta As String) As String
        ...
        Ssql = "DELETE FROM CODIGO_BARRAS "
            ...
            While Cadena <> ""
                ...
                Else
                    If ImportarDesdeCsv = 0 Then
                        ImportarDesdeCsv = "Se actualizaron " & Actualizados & " y se Insertaron " & Insertados & " Registros "
                    Else
                ...
                If Codigo <> "" Then
                    ...
                    Try
                        ...
                        Ssql = "INSERT INTO CODIGO_BARRAS (Codigo_Barras,Proveedor) VALUES('" & Codigo & "','" & Proveedor & "')"
                        cmd = New SqlCommand(Ssql, conn)
                        miDataReader = cmd.ExecuteReader()
...
<head runat="server">
    <title>Importar Codigos de Barras</title>
</head>
<body>
            ...
            <table style="width: 347px; height: 182px">
                <tr>
                    <td align="center" colspan="2" height="1" style="color: #000000">
                        <asp:Label ID="Label17" runat="server" Font-Bold="True" ForeColor="#336677" Text="Importar Códigos de Barras para proveedores" Width="179px"></asp:Label></td>
                </tr>
                <tr>
                    <td align="left" colspan="2" style="height: 24px; text-align: center">
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" ForeColor="Red" Text="Se actualizaran todos los campos de la tabla Codigos de Barras, y se crearan los registros que no se encuentren actualmente"></asp:Label></td>
                </tr>
                <tr>
