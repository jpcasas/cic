...
<script runat="server">
    ...
    Protected Sub CrearArchivo_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ssql = "SELECT HISTORICO_ENTREGAS.FECHAENTREGA, HISTORICO_ENTREGAS.HORAENTREGA, HISTORICO_ENTREGAS.NUMEROENTRADA, HISTORICO_ENTREGAS.COOPERATIVA, HISTORICO_ENTREGAS.MINA, HISTORICO_ENTREGAS.MUNICIPIO, " & _
                      ...
                      " HISTORICO_MUESTRAS_1.AZUFRE AS AZUFRE1, HISTORICO_MUESTRAS_1.PODERCALORLHV AS PODERCALORLHV1, HISTORICO_MUESTRAS_1.FACTORB AS FACTORB1,HISTORICO_MUESTRAS.HUMEDADSUP, HISTORICO_MUESTRAS_1.HUMEDADSUP AS HUMEDADSUP1 " & _
        ...
        If Biblioteca.EjecutarSql(Mensaje, "DELETE FROM FACTURA_TMPXLS") Then ' Reiniciar la tabla temporal            
            ...
            While DtReader.Read
                If Trim(DtReader("MUESTRAESP").ToString) <> "" Then
                    SsqlTmp = " INSERT INTO FACTURA_TMPXLS ( FECHAENTREGA, HORAENTREGA, COOPERATIVA, MINA, NUMEROENTRADA, MUNICIPIO, ACUMPESOS, HUMEDADTOT, CENIZAS, MATVOLATIL, AZUFRE, PODERCALORLHV, FACTORB, PESOCORREGIDO, PODERCALORTOT, NUMERO, VALORTOTALPESOS, PRECIO_GCAL, CAMION,HUMEDADSUP)" & _
                              " VALUES (CONVERT(DATETIME, '" & Format(CDate(DtReader("FECHAENTREGA")), "yyyy-MM-dd 00:00:00") & "', 102),'" & Replace(Format(CDate(DtReader("HORAENTREGA").ToString), "hh:mm:ss tt"), ".", "") & "', '" & Trim(DtReader("COOPERATIVA")) & "', '" & Trim(DtReader("MINA")) & "', '" & Trim(DtReader("NUMEROENTRADA")) & "', '" & DtReader("MUNICIPIO") & "', " & Replace(DtReader("PESONETO"), ",", ".") & ", " & Replace(DtReader("HUMEDADTOT1"), ",", ".") & ", " & Replace(DtReader("CENIZAS1"), ",", ".") & ", " & Replace(DtReader("MATVOLATIL1"), ",", ".") & ", " & Replace(DtReader("AZUFRE1"), ",", ".") & ", " & Replace(DtReader("PODERCALORLHV1"), ",", ".") & ", " & Replace(DtReader("FACTORB1"), ",", ".") & ", 0, 0, '" & DtReader("MUESTRAESP") & "', 0, 0, '" & DtReader("CAMION") & "', " & Replace(DtReader("HUMEDADSUP1"), ",", ".") & ")"
                    
                    
                    
                Else
                    SsqlTmp = " INSERT INTO FACTURA_TMPXLS ( FECHAENTREGA, HORAENTREGA, COOPERATIVA, MINA, NUMEROENTRADA, MUNICIPIO, ACUMPESOS, HUMEDADTOT, CENIZAS, MATVOLATIL, AZUFRE, PODERCALORLHV, FACTORB, PESOCORREGIDO, PODERCALORTOT, NUMERO, VALORTOTALPESOS, PRECIO_GCAL, CAMION,HUMEDADSUP)" & _
                              " VALUES (CONVERT(DATETIME, '" & Format(CDate(DtReader("FECHAENTREGA")), "yyyy-MM-dd 00:00:00") & "', 102), '" & Replace(Format(CDate(DtReader("HORAENTREGA").ToString), "hh:mm:ss tt"), ".", "") & "', '" & Trim(DtReader("COOPERATIVA")) & "', '" & Trim(DtReader("MINA")) & "', '" & Trim(DtReader("NUMEROENTRADA")) & "', '" & DtReader("MUNICIPIO") & "', " & Replace(DtReader("PESONETO"), ",", ".") & ", " & Replace(DtReader("HUMEDADTOT"), ",", ".") & ", " & Replace(DtReader("CENIZAS"), ",", ".") & ", " & Replace(DtReader("MATVOLATIL"), ",", ".") & ", " & Replace(DtReader("AZUFRE"), ",", ".") & ", " & Replace(DtReader("PODERCALORLHV"), ",", ".") & ", " & Replace(DtReader("FACTORB"), ",", ".") & ", 0, 0, '" & DtReader("NUMERO") & "', 0, 0, '" & DtReader("CAMION") & "', " & Replace(DtReader("HUMEDADSUP"), ",", ".") & ")"
        ...
        ssql = "SELECT     FACTURA_TMPXLS.FECHAENTREGA AS fecha, FACTURA_TMPXLS.CAMION AS placa, FACTURA_TMPXLS.NUMEROENTRADA AS código, " & _
                      ...
                      " HISTORICO_ENTREGAS.HORASALIDA AS horasal, FACTURA_TMPXLS.HUMEDADTOT AS humedad, CONVERT(DECIMAL(6,2),((100-FACTURA_TMPXLS.HUMEDADSUP)/100)*FACTURA_TMPXLS.CENIZAS) AS cenizas, " & _
                      " CONVERT(DECIMAL(6,2),((100-FACTURA_TMPXLS.HUMEDADSUP)/100)*FACTURA_TMPXLS.MATVOLATIL) AS volatil, CONVERT(DECIMAL(6,2),((100-FACTURA_TMPXLS.HUMEDADSUP)/100)*FACTURA_TMPXLS.AZUFRE)  AS azufre, FACTURA_TMPXLS.PODERCALORLHV AS pcal, " & _
                      " FACTURA_TMPXLS.PESOCORREGIDO AS p_correg, CONVERT(DECIMAL(6,5),(1.02033 - (0.000042 * POWER(FACTURA_TMPXLS.HUMEDADTOT+(((100-FACTURA_TMPXLS.HUMEDADSUP)/100)*FACTURA_TMPXLS.CENIZAS),2)))) AS f_b, FACTURA_TMPXLS.PODERCALORTOT AS t_mcal, " & _
